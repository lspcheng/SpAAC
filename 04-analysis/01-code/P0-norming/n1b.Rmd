...
All participants were born in and/or spent time before 18 in and were living in California* at the time (based on the screener; except one ).
```{r}
...
```{r}
current_participant <- "5ea637f69b1fb665cf28940b" #participant_list[10] # 
