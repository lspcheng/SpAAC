...
n1b_msAsian <- 
  ...
  # perceived as american-raised > -0.5 (based on visual boundary between groups in scatterplot) (possibly close to ~50% of the time) + top 4-5 most Asian-aligned
  filter(perceived_american_raised > -0.5) %>%  slice_min(perceived_american_diff, n=4)
n1b_msAsian
...
n1b_ethAsian <- 
  ...
  # perceived as Asian-raised < -0.5 + top 5 most American-aligned
  filter(perceived_american_raised < -0.5) %>% slice_max(perceived_american_aligned, n=4)
n1b_ethAsian
