...
# Plot grand means
w_meanintensity_df %>%
  ggplot(aes(x=variant, y=meanintensity)) + theme_minimal() +
  stat_summary(geom="pointrange")

w_meanintensity_df %>%
  ggplot(aes(x=variableN, y=meanintensity, linetype=variant, color=variable)) + theme_minimal() +
  stat_summary(geom="pointrange", position=position_dodge(0.95)) +
  scale_x_continuous(limits = c(0, 9), breaks=1:8)
...
for (spk_num in speaker_list){
  ...
  ggplot(aes(x=variableN, y=meanintensity, linetype=variant, color=variable)) + theme_minimal() + facet_wrap(~speaker) +
  # geom_point(alpha=0.2) +
  # stat_summary(geom="col", alpha=0.5, position="dodge") +
  stat_summary(geom="pointrange", position=position_dodge(0.95)) +
  scale_x_continuous(limits = c(0, 9), breaks=1:8)
...
w_normtimeIntensity_df %>%
  ggplot(aes(x=timepoint, y=normtimeIntensity)) + theme_minimal() +
  # geom_point(alpha=0.2) +
  # stat_summary(geom="col", alpha=0.5, position="dodge") +
  stat_summary(geom="pointrange", position=position_dodge(0.95)) +
...
w_normtimeIntensity_df %>%
  ggplot(aes(x=timepoint, y=normtimeIntensity, col=variant)) + theme_minimal() +
  # geom_point(alpha=0.2) +
  # stat_summary(geom="col", alpha=0.5, position="dodge") +
...
w_normtimeIntensity_df %>%
  ggplot(aes(x=timepoint, y=normtimeIntensity, col=variant)) + theme_minimal() + facet_wrap(~variableN) +
  # geom_point(alpha=0.2) +
  # stat_summary(geom="col", alpha=0.5, position="dodge") +
  stat_summary(geom="pointrange", position=position_dodge()) +
  stat_summary(geom="smooth", position=position_dodge()) +
...
for (spk_num in speaker_list){
  ...
  # Across all tokens
    ggplot(aes(x=timepoint, y=normtimeIntensity)) + theme_minimal() + facet_wrap(~speaker) +
    # geom_point(alpha=0.2) +
    # stat_summary(geom="col", alpha=0.5, position="dodge") +
    stat_summary(geom="pointrange", position=position_dodge(0.95)) +
    stat_summary(geom="smooth", position=position_dodge(0.95)) +
  ...
  # Between-variant comparison (across all variables)
  plot <- w_normtimeIntensity_df %>% filter(speaker==spk_num) %>%
    ggplot(aes(x=timepoint, y=normtimeIntensity, col=variant)) + theme_minimal() + facet_wrap(~speaker) +
    # geom_point(alpha=0.2) +
    # stat_summary(geom="col", alpha=0.5, position="dodge") +
    stat_summary(geom="pointrange", position=position_dodge()) +
    stat_summary(geom="smooth", position=position_dodge()) +
  ...
  # By variable + between-variant comparison
  plot <- w_normtimeIntensity_df %>% filter(speaker==spk_num) %>%
    ggplot(aes(x=timepoint, y=normtimeIntensity, col=variant)) + theme_minimal() + facet_wrap(~speaker) + facet_wrap(~variableN) +
    # geom_point(alpha=0.2) +
    # stat_summary(geom="col", alpha=0.5, position="dodge") +
    stat_summary(geom="pointrange", position=position_dodge()) +
    stat_summary(geom="smooth", position=position_dodge()) +
...
for (var_num in c(1:8)){
  plot1 <- w_normtimeIntensity_df %>% filter(speaker==current_speaker) %>%
    ...
    ggplot(aes(x=timepoint, y=normtimeIntensity, col=variant)) + theme_minimal() + facet_wrap(~variable) +
    stat_summary(geom="pointrange", position=position_dodge()) +
...
```{r}
ft_normform_df %>% filter(item_code %in% c("7-7-1", "7-7-3"))
ft_normform_df %>% filter(variableN==7)
```
...
# Across all tokens
ft_normform_df %>%
  ggplot(aes(x=timepoint, y=normform_raw, linetype=formant)) + theme_minimal() +
  # geom_point(alpha=0.2) +
  # stat_summary(geom="col", alpha=0.5, position="dodge") +
  stat_summary(geom="pointrange", position=position_dodge(0.95)) +
  stat_summary(geom="smooth", position=position_dodge(0.95)) +
...
# Between-variant comparison (across all variables)
ft_normform_df %>%
  ggplot(aes(x=timepoint, y=normform_raw, col=variant, linetype=formant)) + theme_minimal() +
  # geom_point(alpha=0.2) +
  # stat_summary(geom="col", alpha=0.5, position="dodge") +
  stat_summary(geom="pointrange", position=position_dodge()) +
  stat_summary(geom="smooth", position=position_dodge()) +
...
# By variable + between-variant comparison
ft_normform_df %>%
  ggplot(aes(x=timepoint, y=normform_raw, col=variant, linetype=formant)) + theme_minimal() + facet_wrap(~variable) +
  # geom_point(alpha=0.2) +
  # stat_summary(geom="col", alpha=0.5, position="dodge") +
  stat_summary(geom="pointrange", position=position_dodge()) +
  stat_summary(geom="smooth", position=position_dodge()) +
...
for (spk_num in speaker_list){
  ...
  # By variable + between-variant comparison
  plot <- ft_normform_df %>% filter(speaker==spk_num) %>%
    ggplot(aes(x=timepoint, y=normform_raw, col=variant, linetype=formant)) + theme_minimal() + facet_wrap(~speaker) + facet_wrap(~variable) +
    # geom_point(alpha=0.2) +
    # stat_summary(geom="col", alpha=0.5, position="dodge") +
    stat_summary(geom="pointrange", position=position_dodge()) +
    stat_summary(geom="smooth", position=position_dodge()) +
